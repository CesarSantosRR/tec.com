...
<html lang="pt-br">
    ...
    <body class="cadastro_cliente">
        <header id="header_cadastro">
            <h2><b>Cadastro do Cliente</b></h2>
        </header>
        <div class="container"> 
            ...
            <div class="container">
                <form method="POST" name="Form1" action="valcad.php"><br/>
                    <div class="form-row">
                        ...
                        <input type="text" class="form-control" name="nome" id="nome" placeholder="Nome" required autofocus="1">
                    </div><br/>
                    <div class="form-row">
                    ...
                    <button type="submit" class="btn btn-primary" name="salvar1">Cadastrar</button>                    
                <br/><br/>
            </form> 
        </div>
    </div><br>
